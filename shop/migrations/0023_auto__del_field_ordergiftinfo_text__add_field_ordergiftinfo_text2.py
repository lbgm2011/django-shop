...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderGiftInfo.text'
        db.delete_column(u'shop_ordergiftinfo', 'text')

        # Adding field 'OrderGiftInfo.text2'
        db.add_column(u'shop_ordergiftinfo', 'text2',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OrderGiftInfo.text'
        db.add_column(u'shop_ordergiftinfo', 'text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'OrderGiftInfo.text2'
        db.delete_column(u'shop_ordergiftinfo', 'text2')
