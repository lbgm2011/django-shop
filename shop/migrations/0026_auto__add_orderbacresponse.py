...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderBacResponse'
        db.create_table(u'shop_orderbacresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responsebac', to=orm['shop.Order'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('response', self.gf('django.db.models.fields.IntegerField')()),
            ('responsetext', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('authcode', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('transactionid', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('avsresponse', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('hash', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('cvvresponse', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('response_code', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal('shop', ['OrderBacResponse'])


    def backwards(self, orm):
        # Deleting model 'OrderBacResponse'
        db.delete_table(u'shop_orderbacresponse')
    ...
    models = {
        ...
        'shop.orderbacresponse': {
            'Meta': {'object_name': 'OrderBacResponse'},
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'authcode': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'avsresponse': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'cvvresponse': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'hash': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'responsebac'", 'to': "orm['shop.Order']"}),
            'response': ('django.db.models.fields.IntegerField', [], {}),
            'response_code': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'responsetext': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'transactionid': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        'shop.orderextrainfo': {
        ...
        'shop.ordergiftinfo': {
            'Meta': {'object_name': 'OrderGiftInfo'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'gift_info'", 'to': "orm['shop.Order']"}),
        ...
        'shop.orderstatus': {
            ...
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'status_info'", 'to': "orm['shop.Order']"}),
        ...
        'shop.product': {
            ...
            'precio_oferta': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'null': 'True', 'max_digits': '30', 'decimal_places': '2'}),
        ...
        u'website.categoria': {
            ...
            'destacada': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
