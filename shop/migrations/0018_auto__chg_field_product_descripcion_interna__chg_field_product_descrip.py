...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.descripcion_interna'
        db.alter_column(u'shop_product', 'descripcion_interna', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Product.descripcion'
        db.alter_column(u'shop_product', 'descripcion', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Product.descripcion_interna'
        db.alter_column(u'shop_product', 'descripcion_interna', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Product.descripcion'
        db.alter_column(u'shop_product', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'shop.product': {
            ...
            'descripcion_interna': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
