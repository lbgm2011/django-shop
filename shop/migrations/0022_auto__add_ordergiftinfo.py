...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderGiftInfo'
        db.create_table(u'shop_ordergiftinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gift_info', to=orm['shop.Order'])),
            ('text', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('shop', ['OrderGiftInfo'])


    def backwards(self, orm):
        # Deleting model 'OrderGiftInfo'
        db.delete_table(u'shop_ordergiftinfo')
