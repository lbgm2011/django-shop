...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.descripcion_interna'
        db.add_column(u'shop_product', 'descripcion_interna',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.descripcion_interna'
        db.delete_column(u'shop_product', 'descripcion_interna')
    ...
    models = {
        ...
        'shop.product': {
            ...
            'descripcion_interna': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
