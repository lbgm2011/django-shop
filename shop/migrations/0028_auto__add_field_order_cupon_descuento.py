...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.cupon_descuento'
        db.add_column(u'shop_order', 'cupon_descuento',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.cupon_descuento'
        db.delete_column(u'shop_order', 'cupon_descuento')
    ...
    models = {
        ...
        'shop.order': {
            ...
            'cupon_descuento': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'shop.orderstatus': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
