...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderStatus.comentario'
        db.add_column(u'shop_orderstatus', 'comentario',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


        # Changing field 'OrderStatus.created'
        db.alter_column(u'shop_orderstatus', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'OrderStatus.comentario'
        db.delete_column(u'shop_orderstatus', 'comentario')


        # Changing field 'OrderStatus.created'
        db.alter_column(u'shop_orderstatus', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        'shop.orderstatus': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'status_info'", 'to': "orm['shop.Order']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '40'})
        },
        'shop.product': {
