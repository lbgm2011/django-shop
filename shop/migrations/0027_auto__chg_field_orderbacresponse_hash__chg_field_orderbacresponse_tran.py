...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderBacResponse.hash'
        db.alter_column(u'shop_orderbacresponse', 'hash', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'OrderBacResponse.transactionid'
        db.alter_column(u'shop_orderbacresponse', 'transactionid', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'OrderBacResponse.hash'
        db.alter_column(u'shop_orderbacresponse', 'hash', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'OrderBacResponse.transactionid'
        db.alter_column(u'shop_orderbacresponse', 'transactionid', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'shop.orderbacresponse': {
            ...
            'transactionid': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'shop.orderextrainfo': {
