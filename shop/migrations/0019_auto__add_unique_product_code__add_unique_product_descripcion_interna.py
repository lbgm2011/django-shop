...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'shop_product', ['code'])

        # Adding unique constraint on 'Product', fields ['descripcion_interna']
        db.create_unique(u'shop_product', ['descripcion_interna'])


    def backwards(self, orm):
        # Removing unique constraint on 'Product', fields ['descripcion_interna']
        db.delete_unique(u'shop_product', ['descripcion_interna'])

        # Removing unique constraint on 'Product', fields ['code']
        db.delete_unique(u'shop_product', ['code'])
